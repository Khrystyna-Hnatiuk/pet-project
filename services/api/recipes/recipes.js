...
var recipes = [
    {
        ...
        instructions: "Prepare the ingredients and cook borscht following standard steps.",
        time: "45 minutes",
    ...
    },
    {
        ...
        title: "Chicken Curry",
        category: "Main",
        ingredients: ["chicken", "curry powder", "onion", "garlic", "cream"],
        instructions: "Cook chicken with curry and cream sauce until tender.",
        time: "50 minutes",
        image: "https://i.pinimg.com/736x/83/a0/25/83a025d8a4fcc319d38bdc26316ce3f2.jpg"
    },
    {
        id: 3,
        title: "Syrnyky",
...
app.get("/", function (req, res) {
    res.send("🍽 Welcome to the Yummy Food API");
});
...
app.get("/api/recipes/:id", function (req, res) {
    var recipe = recipes.find(function (r) { return r.id === parseInt(req.params.id); });
    if (recipe) {
        res.json(recipe);
    }
    else {
